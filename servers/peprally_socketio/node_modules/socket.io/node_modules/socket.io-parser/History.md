 ...
 * playerIndex: fix off-by-one bound checks

2.2.3 / 2015-02-03
==================

 * playerIndex: fix potential infinite loop with malicious binary packet
 ...
 * playerIndex: use `json3`

1.0.3 / 2012-12-18
==================

  * playerIndex: added instrumentation through `debug`
  * playerIndex: make sure decoded `id` is a `Number`

1.0.2 / 2012-12-18
==================

  * playerIndex: allow for falsy values in `id` and `data`
