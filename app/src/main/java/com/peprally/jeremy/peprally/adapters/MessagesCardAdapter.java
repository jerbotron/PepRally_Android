...
public class MessagesCardAdapter extends RecyclerView.Adapter<MessagesCardAdapter.MessageCardHolder>{

    private Context callingContext;

    private List<DBUserNotification> notifications;

    public MessagesCardAdapter(Context callingContext,
    ...
    public void onBindViewHolder(MessageCardHolder MessageCardHolder, int position) {
        ...
        Helpers.setFacebookProfileImage(callingContext,
                MessageCardHolder.userNotifyingImage,
                userNotification.getFacebookIDSender(),
                3);

        MessageCardHolder.timeStamp.setText(Helpers.getTimeStampString(userNotification.getTimeInSeconds()));
        ...
        MessageCardHolder.content.setText(Html.fromHtml("<b>"+userNotification.getNicknameSender()+"</b> " + content));
